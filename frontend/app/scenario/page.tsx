    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: "var(--gradient-subtle)" }}>
      <div className="w-full max-w-2xl card p-8 animate-slide-up">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2 bg-surface-raised border border-border p-1 rounded-lg">
            <button
              onClick={() => setLang("en")}
              className={`px-3 py-1 text-sm rounded-md transition-colors cursor-pointer ${
                lang === "en"
                  ? "bg-surface shadow text-text-primary border border-border font-medium"
        ...
        <div className="bg-surface p-6 rounded-xl border mb-8" style={{ borderColor: "var(--border)" }}>

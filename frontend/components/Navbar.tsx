      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg transition-all hover:bg-border-light cursor-pointer"
            ...
            <Link
              href="/cart"
              className="relative p-2 rounded-lg transition-all hover:bg-border-light"
            >
            ...
            {mounted && isAuthenticated() ? (
              <div className="flex items-center gap-2">
                <Link
                  href="/profile"
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all hover:bg-border-light"
                >
                  <div
          ...
          <div className="flex md:hidden items-center gap-1">
            ...
            {/* Mobile hamburger */}
            <button
              className="p-2 rounded-lg hover:bg-border-light cursor-pointer"

    ...
    <>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="bg-white rounded-xl shadow-xl max-w-lg w-full p-6 animate-slide-up relative text-black">
      ...
      {/* "Only chance" banner for WP-5 */}
      <div className="bg-amber-100 text-amber-900 px-4 py-1.5 text-xs text-center border-b border-amber-200">
        {lang === "tr" ? "Tek oturum — iyi değerlendirin." : "Single session — make it count."}
      </div>
    </>
  );
}
